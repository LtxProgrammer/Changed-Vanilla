...
public class LatexFoxModel extends AdvancedHumanoidModel<LatexFox> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(56, 8).addBox(-1.5F, -3.0F, -7.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));
    ...
    @Override
    public HumanoidAnimator<LatexFox, LatexFoxModel> getAnimator(LatexFox entity) {
        return animator;
    }
}
